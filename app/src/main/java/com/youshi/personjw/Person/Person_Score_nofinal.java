 ...
 */
public class Person_Score_nofinal extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = Person_Score_nofinal.this.getIntent();
    ...
    private void init(){
        ...
        scores = new Score[30];
        tv01 = (TextView) findViewById(R.id.person_score_01tv);tv02 = (TextView) findViewById(R.id.person_score_02tv);
        tv03 = (TextView) findViewById(R.id.person_score_03tv);tv04 = (TextView) findViewById(R.id.person_score_04tv);
        tv05 = (TextView) findViewById(R.id.person_score_05tv);tv06 = (TextView) findViewById(R.id.person_score_06tv);
        tv07 = (TextView) findViewById(R.id.person_score_07tv);
    ...
    private void sub_init(){
        tv01.setText("课程名");tv02.setText("总评");tv03.setText("学分");tv04.setText("学时");
        tv05.setText("考核方式");tv06.setText("是否缓考");tv07.setText("二学位/辅修");
    }
    ...
    class Person_MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what == 100) {
                ...
                SimpleAdapter simpleAdapter = new SimpleAdapter(Person_Score_nofinal.this,listItem,R.layout.person_score_list_items,new String[]
